...
import { createPermissionPerEmployeeQuery, getCatPermissionsQuery, getEconomicosPerYearQuery, getEmployeesPermissionsQuery, getPermissionDetailsQuery } from "../helpers/permissionsQueries";
