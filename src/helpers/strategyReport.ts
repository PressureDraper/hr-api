    ...
    <section class="main">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 d-flex justify-content-center">
                    <p style="font-size: 14px;">SERVICIOS DE SALUD DEL INSTITUTO MEXICANO DEL SEGURO SOCIAL</p>
                </div>
                <div class="col-sm-12 d-flex justify-content-center">
                    <p style="font-size: 14px;">PARA EL BIENESTAR (IMSS-BIENESTAR)</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-center">
                    <p class="subtitle" style="font-size: 14px;">"SUSTITUCIÓN TRABAJADOR POR TRABAJADOR, TxT"</p>
                </div>
                <div class="col-sm-12 d-flex justify-content-center">
                    <p class="subtitle" style="font-size: 14px;">CÉDULA DE AUTORIZACIÓN</p>
                </div>
            </div>
            ...
            <div class="row d-flex justify-content-center mx-auto" style="width: 95vw;">
                <div class="col-sm-12 d-flex flex-column justify-content-center align-items-start">
                    <span style="letter-spacing: 0.3px; text-align: justify; font-size: 12.5px;">Los trabajadores que a continuación se
